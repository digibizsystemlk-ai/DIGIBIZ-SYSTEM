...
const BUSINESS_TYPES = {
    ...
    quick_billing: {
        ...
        menus: [
            { icon: "🧾", name: "Quick Billing Terminal", link: "/modules/quick_billing/app.html", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN", "MANAGER", "ACCOUNTANT", "CASHIER", "STAFF", "VIEWER", "USER"] },
            { icon: "📜", name: "Bill History", link: "/modules/quick_billing/app.html", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN", "MANAGER", "ACCOUNTANT", "CASHIER", "STAFF", "VIEWER", "USER"] },
            { icon: "💳", name: "Subscription & Plans", link: "/modules/quick_billing/subscription.html", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN"] },

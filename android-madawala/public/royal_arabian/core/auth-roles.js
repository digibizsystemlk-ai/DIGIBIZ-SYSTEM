...
async function getUserRole(userId, businessId = null) {
    ...
    try {
        ...
        if (isSuperAdminEmail && !isImpersonating) {
            return { role: 'SUPER_ADMIN', businessId: 'oDhSDYHQ2dV1DP33koysmZAqaY13' };
        }

        // 1. GLOBAL STAFF REGISTRY PRIORITY
        ...
        // 2. BUSINESS CONTEXT PRIORITY (Security first)

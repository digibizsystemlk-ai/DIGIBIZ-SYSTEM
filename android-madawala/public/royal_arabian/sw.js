...
const PRECACHE_URLS = [
  ...
  "/",
  "/index.html",
  "/royal_arabian/modules/quick_billing/app.html",
  "/royal_arabian/modules/quick_billing/app.js",
  "/royal_arabian/modules/quick_billing/products.html",
  "/royal_arabian/modules/quick_billing/customers.html",
  "/royal_arabian/modules/quick_billing/credit.html",
  "/royal_arabian/modules/quick_billing/user-manual.html",
  "/royal_arabian/modules/quick_billing/manifest.json",
  "/royal_arabian/modules/distributor/web/distributor-repapp.html",

  // Core Scripts & Framework
  "/royal_arabian/core/pwa-init.js",
  "/royal_arabian/core/firebase-init.js",
  "/royal_arabian/core/sidebar.js",
  "/royal_arabian/core/business-types.js",
  "/royal_arabian/core/auth-roles.js",
  "/royal_arabian/core/dashboard-core.js",
  "/royal_arabian/core/aggregate-utils.js",
  "/royal_arabian/core/subscription-manager.js",
  "/scripts/admin-impersonation.js",
  "/royal_arabian/core/auth-utils.js",
  "/royal_arabian/core/offline-auth.js",

  // Vendor Libraries
  "/royal_arabian/assets/vendor/html2canvas.min.js",
  "/royal_arabian/assets/vendor/sweetalert2.all.min.js",
  "/royal_arabian/assets/vendor/firebase-app-compat.js",
  "/royal_arabian/assets/vendor/firebase-auth-compat.js",
  "/royal_arabian/assets/vendor/firebase-firestore-compat.js",

  // Manifests & Icons
  "/royal_arabian/manifest.json",
  "/icons/icon-192.svg",
  "/icons/icon-512.svg"
];
      ...
      fetch(event.request)
        ...
        .catch(async () => {
          ...
          if (url.pathname.includes('/quick_billing/')) {
            const qbCached = await caches.match("/royal_arabian/modules/quick_billing/app.html');
            if (qbCached) return qbCached;
          }

          // D. Distributor rep app fallback
          if (url.pathname.includes('/distributor/')) {
            const distCached = await caches.match("/royal_arabian/modules/distributor/web/distributor-repapp.html');
            if (distCached) return distCached;
          }

          // E. Default root fallback
          const rootCached = await caches.match("/royal_arabian/modules/quick_billing/app.html') || await caches.match('/');

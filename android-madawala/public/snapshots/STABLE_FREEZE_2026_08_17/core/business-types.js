...
const BUSINESS_TYPES = {
    ...
    quick_billing: {
        ...
        menus: [
            ...
            { icon: "📦", name: "Manage Products & Prices", link: "/modules/quick_billing/app.html?view=products", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN", "MANAGER", "ACCOUNTANT", "CASHIER", "STAFF", "VIEWER", "USER"] },
            { icon: "👥", name: "Customers Directory", link: "/modules/quick_billing/app.html?view=customers", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN", "MANAGER", "ACCOUNTANT", "CASHIER", "STAFF", "VIEWER", "USER"] },

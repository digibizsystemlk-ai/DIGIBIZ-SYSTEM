...
(function () {
    ...
    function ensureManifest() {
        ...
        } else if (window.location.pathname.indexOf('blog.html') !== -1 || window.location.pathname.indexOf('/blog') !== -1) {
            l.href = '/blog-manifest.json';
        } else {
    ...
    if ('serviceWorker' in navigator) {
        window.addEventListener('load', function () {
            navigator.serviceWorker.register('/sw.js?v=3250').then(function(reg) {

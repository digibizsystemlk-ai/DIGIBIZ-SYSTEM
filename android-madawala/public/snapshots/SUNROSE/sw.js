...
const PRECACHE_URLS = [
  ...
  "/",
  "/index.html",
  "/snapshots/SUNROSE/modules/quick_billing/app.html",
  "/snapshots/SUNROSE/modules/quick_billing/app.js",
  "/snapshots/SUNROSE/modules/quick_billing/products.html",
  "/snapshots/SUNROSE/modules/quick_billing/customers.html",
  "/snapshots/SUNROSE/modules/quick_billing/credit.html",
  "/snapshots/SUNROSE/modules/quick_billing/user-manual.html",
  "/snapshots/SUNROSE/modules/quick_billing/manifest.json",
  "/snapshots/SUNROSE/modules/distributor/web/distributor-repapp.html",

  // Core Scripts & Framework
  "/snapshots/SUNROSE/core/pwa-init.js",
  "/snapshots/SUNROSE/core/firebase-init.js",
  "/snapshots/SUNROSE/core/sidebar.js",
  "/snapshots/SUNROSE/core/business-types.js",
  "/snapshots/SUNROSE/core/auth-roles.js",
  "/snapshots/SUNROSE/core/dashboard-core.js",
  "/snapshots/SUNROSE/core/aggregate-utils.js",
  "/snapshots/SUNROSE/core/subscription-manager.js",
  "/scripts/admin-impersonation.js",
  "/snapshots/SUNROSE/core/auth-utils.js",
  "/snapshots/SUNROSE/core/offline-auth.js",

  // Vendor Libraries
  "/snapshots/SUNROSE/assets/vendor/html2canvas.min.js",
  "/snapshots/SUNROSE/assets/vendor/sweetalert2.all.min.js",
  "/snapshots/SUNROSE/assets/vendor/firebase-app-compat.js",
  "/snapshots/SUNROSE/assets/vendor/firebase-auth-compat.js",
  "/snapshots/SUNROSE/assets/vendor/firebase-firestore-compat.js",

  // Manifests & Icons
  "/snapshots/SUNROSE/manifest.json",
  "/icons/icon-192.svg",
  "/icons/icon-512.svg"
];
      ...
      fetch(event.request)
        ...
        .catch(async () => {
          ...
          if (url.pathname.includes('/quick_billing/')) {
            const qbCached = await caches.match("/snapshots/SUNROSE/modules/quick_billing/app.html');
            if (qbCached) return qbCached;
          }

          // D. Distributor rep app fallback
          if (url.pathname.includes('/distributor/')) {
            const distCached = await caches.match("/snapshots/SUNROSE/modules/distributor/web/distributor-repapp.html');
            if (distCached) return distCached;
          }

          // E. Default root fallback
          const rootCached = await caches.match("/snapshots/SUNROSE/modules/quick_billing/app.html') || await caches.match('/');

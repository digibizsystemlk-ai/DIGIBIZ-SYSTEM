...
const BUSINESS_TYPES = {
    communication: {
        id: "communication",
        name: "Communication & Phone Repair Center",
        icon: "📡",
        description: "POS Photocopy counter, phone/laptop repairs, sublimation printing, spares inventory, double-entry accounting & 360° reports",
        menus: [
            { icon: "📊", name: "Dashboard", link: "/demo/communication#dashboard", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN", "MANAGER", "ACCOUNTANT", "CASHIER", "STAFF", "VIEWER"] },
            { icon: "🛒", name: "Quick POS", link: "/demo/communication#pos", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN", "MANAGER", "CASHIER", "STAFF"] },
            { icon: "🛠️", name: "Repair Desk", link: "/demo/communication#repairs", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN", "MANAGER", "STAFF"] },
            { icon: "🖨️", name: "Print Studio", link: "/demo/communication#printing", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN", "MANAGER", "STAFF"] },
            { icon: "📦", name: "Stock & Spares", link: "/demo/communication#stock", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN", "MANAGER", "STORE_KEEPER"] },
            { icon: "⚖️", name: "Accounting", link: "/demo/communication#accounting", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT"] },
            { icon: "💸", name: "Expenses", link: "/demo/communication#expenses", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT"] },
            { icon: "👥", name: "Customers", link: "/demo/communication#customers", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ADMIN", "MANAGER"] },
            { icon: "📊", name: "Reports", link: "/demo/communication#reports", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT"] },
            { icon: "💎", name: "Subscription", link: "/demo/communication#subscription", role: ["SUPER_ADMIN", "BUSINESS_OWNER"] }
        ],
        dashboardComponents: ["sales", "repairs", "printStudio", "cashDrawer", "inventory"],
        demoEmail: "test@communication.com",
        isReady: true
    },
    ...
    manufacturer: {
        ...
        menus: [
            { icon: "📊", name: "Dashboard", link: "/demo/factory#dashboard", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT", "MANAGER", "VIEWER"] },
            { icon: "🧱", name: "Raw Materials", link: "/demo/factory#raw-materials", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT", "MANAGER", "VIEWER"] },
            { icon: "🏭", name: "Production / Manufacturing", link: "/demo/factory#production", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT", "MANAGER", "VIEWER"] },
            { icon: "📦", name: "Finished Goods / Stock", link: "/demo/factory#stock", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT", "MANAGER", "VIEWER"] },
            { icon: "🛍️", name: "Sales POS", link: "/demo/factory#sales", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT", "MANAGER", "VIEWER"] },
            { icon: "🧾", name: "Expenses", link: "/demo/factory#expenses", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT", "MANAGER", "VIEWER"] },
            { icon: "📁", name: "Accounting", link: "/demo/factory#accounting", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT", "MANAGER", "VIEWER"] },
            { icon: "📚", name: "History", link: "/demo/factory#history", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT", "MANAGER", "VIEWER"] },
            { icon: "📈", name: "Reports", link: "/demo/factory#reports", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT", "MANAGER", "VIEWER"] },
            { icon: "👥", name: "Customers", link: "/demo/factory#customers", role: ["SUPER_ADMIN", "BUSINESS_OWNER", "ACCOUNTANT", "MANAGER", "VIEWER"] }
        ],
        dashboardComponents: [

...
(function initSuperAdminImpersonation() {
    ...
    if (path === '/' || path === '/index.html' || path.includes('/auth/login.html')) {
        ...
        let targetModulePath = '/modules/retail/dashboard.html';
        if (normType === 'distributor') targetModulePath = '/modules/distributor/web/dashboard.html';
        else if (normType === 'attendance_payroll' || normType === 'attendance') targetModulePath = '/modules/attendance_payroll/dashboard.html';
        else if (normType === 'auto_care') targetModulePath = '/modules/auto_care/dashboard.html';
        else if (normType === 'bakery') targetModulePath = '/modules/bakery/dashboard.html';
        else if (normType === 'coconut') targetModulePath = '/modules/coconut/dashboard.html';
        else if (normType === 'hardware') targetModulePath = '/modules/hardware/dashboard.html';
        else if (normType === 'manufacturer') targetModulePath = '/modules/manufacturer/dashboard.html';
        else if (normType === 'pharmacy') targetModulePath = '/modules/pharmacy/dashboard.html';
        else if (normType === 'quick_billing') targetModulePath = '/modules/quick_billing/dashboard.html';
        else if (normType === 'scrap_collection_center') targetModulePath = '/modules/scrap_collection_center/dashboard.html';
        else if (normType === 'tire_centre') targetModulePath = '/modules/tire_centre/dashboard.html';
        else targetModulePath = `/modules/${normType}/dashboard.html`;

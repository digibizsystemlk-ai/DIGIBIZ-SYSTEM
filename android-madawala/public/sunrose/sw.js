...
const PRECACHE_URLS = [
  ...
  "/",
  "/index.html",
  "/sunrose/modules/quick_billing/app.html",
  "/sunrose/modules/quick_billing/app.js",
  "/sunrose/modules/quick_billing/products.html",
  "/sunrose/modules/quick_billing/customers.html",
  "/sunrose/modules/quick_billing/credit.html",
  "/sunrose/modules/quick_billing/user-manual.html",
  "/sunrose/modules/quick_billing/manifest.json",
  "/sunrose/modules/distributor/web/distributor-repapp.html",

  // Core Scripts & Framework
  "/sunrose/core/pwa-init.js",
  "/sunrose/core/firebase-init.js",
  "/sunrose/core/sidebar.js",
  "/sunrose/core/business-types.js",
  "/sunrose/core/auth-roles.js",
  "/sunrose/core/dashboard-core.js",
  "/sunrose/core/aggregate-utils.js",
  "/sunrose/core/subscription-manager.js",
  "/scripts/admin-impersonation.js",
  "/sunrose/core/auth-utils.js",
  "/sunrose/core/offline-auth.js",

  // Vendor Libraries
  "/sunrose/assets/vendor/html2canvas.min.js",
  "/sunrose/assets/vendor/sweetalert2.all.min.js",
  "/sunrose/assets/vendor/firebase-app-compat.js",
  "/sunrose/assets/vendor/firebase-auth-compat.js",
  "/sunrose/assets/vendor/firebase-firestore-compat.js",

  // Manifests & Icons
  "/sunrose/manifest.json",
  "/icons/icon-192.svg",
  "/icons/icon-512.svg"
];
      ...
      fetch(event.request)
        ...
        .catch(async () => {
          ...
          if (url.pathname.includes('/quick_billing/')) {
            const qbCached = await caches.match("/sunrose/modules/quick_billing/app.html');
            if (qbCached) return qbCached;
          }

          // D. Distributor rep app fallback
          if (url.pathname.includes('/distributor/')) {
            const distCached = await caches.match("/sunrose/modules/distributor/web/distributor-repapp.html');
            if (distCached) return distCached;
          }

          // E. Default root fallback
          const rootCached = await caches.match("/sunrose/modules/quick_billing/app.html') || await caches.match('/');

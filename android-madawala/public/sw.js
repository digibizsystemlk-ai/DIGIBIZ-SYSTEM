const CACHE_NAME = "digibiz-bill-offline-v2026_v600";
const PRECACHE_URLS = [
  // Core Entrypoints
  "/",
  "/index.html",
  "/modules/quick_billing/app.html",
  "/modules/quick_billing/app.js",
  "/modules/quick_billing/products.html",
  "/modules/quick_billing/customers.html",
  "/modules/quick_billing/credit.html",
  "/modules/quick_billing/user-manual.html",
  "/modules/quick_billing/manifest.json",
  ...
  "/core/sidebar.js",
  "/core/business-types.js",
  "/core/auth-roles.js",
  "/core/dashboard-core.js",
  "/core/aggregate-utils.js",
  "/core/subscription-manager.js",
      ...
      fetch(event.request)
        ...
        .catch(async () => {
          ...
          if (url.pathname.includes('/quick_billing/')) {
            const qbCached = await caches.match('/modules/quick_billing/app.html');
            if (qbCached) return qbCached;
          }

          // D. Distributor rep app fallback
          if (url.pathname.includes('/distributor/')) {
            const distCached = await caches.match('/modules/distributor/web/distributor-repapp.html');
            if (distCached) return distCached;
          }

          // E. Default root fallback
          const rootCached = await caches.match('/modules/quick_billing/app.html') || await caches.match('/');

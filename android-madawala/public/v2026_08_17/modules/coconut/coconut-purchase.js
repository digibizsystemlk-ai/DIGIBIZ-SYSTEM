...
async function handleSavePurchase(e) {
    ...
    try {
        ...
        window.CoconutModule.showToast('✅ Coconut purchase saved & stock updated!', 'success');
...
async function handleSaveQuickSupplier(e) {
    ...
    const defaultRate = Number(document.getElementById('supDefaultRate').value) || 0;
    ...
    try {
        ...
        window.CoconutModule.showToast('Supplier registered!', 'success');
